...
1.  Go to the top level pwpbase repository: <https://github.com/polishedwp/modulus>
2.  Click the "Fork" Button in the upper right hand corner of the interface ([More Details Here](https://help.github.com/articles/fork-a-repo/))
3.  After the repository (repo) has been forked, you will be taken to your copy of the prometheus repo at <https://github.com/yourUsername/modulus>
...
This will download the entire modulus repo to your project's directory.

### Setup Your Upstream

1.  Change directory to the new modulus directory (`cd modulus`)
2.  Add a remote to the original pwpbase repo:

```shell
$ git remote add upstream https://github.com/polishedwp/modulus.git
```
